...
// Subcomponents extracted for better code management
...
function Header({ isSidebarOpen, setIsSidebarOpen, onShare, sharedCopied }: HeaderProps) {
  return (
...
function Sidebar({ selectedTemplate, onTemplateSelect, isSidebarOpen }: SidebarProps) {
  return (
    <aside
