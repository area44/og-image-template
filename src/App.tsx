  ...
  useEffect(() => {
    ...
    async function renderOG() {
      try {
        ...
        const TemplateComponent = TEMPLATES[selectedTemplate].component as React.ComponentType<{ title?: string; description?: string }>;
        ...
        <div className="w-full lg:w-[420px] border-r border-zinc-800 flex flex-col bg-zinc-900/20 divide-y divide-zinc-800/80 overflow-y-auto">
          ...
          <div className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-sm font-semibold text-zinc-300 uppercase tracking-wider">Choose Template</h2>
            </div>
          ...
          <div className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-sm font-semibold text-zinc-300 uppercase tracking-wider">Customize Content</h2>
            </div>
          ...
          <div className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-sm font-semibold text-zinc-300 uppercase tracking-wider">Dimensions</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  onClick={() => { setWidth(800); setHeight(400); }}
                  className="flex-1 py-1 px-2.5 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-700 text-xs text-zinc-400 rounded transition"
                >
                  Compact (800×400)
                </button>
          ...
          <div className="flex-1 w-full flex items-center justify-center min-h-[300px] relative">
            {fontsLoading ? (
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-sm text-zinc-400 font-medium">Fetching font files for Satori...</p>
              </div>
            ) : fontsError ? (
